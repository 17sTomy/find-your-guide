...
public class UsuarioFactory {
    public static Usuario createUsuario(Rol tipo, String nombre, String apellido, Sexo sexo, String dni, String email, String password, String numTelefono, Stream fotoPerfil, IAuthenticacion auth) {
        switch (tipo) {
            case TURISTA:
