...
public class UsuarioDTOFactory {
    public static UsuarioDTO createUsuarioDTO(Usuario usuario) {
        if (usuario instanceof Guia) {
            ...
            return new GuiaDTO(guia.getNombre(), guia.getApellido(), guia.getDni(), guia.getSexo(), guia.getEmail(), guia.getNumTelefono(), guia.getFotoPerfil(), guia.getAuth(), guia.getServicio(), guia.getPais(), guia.getCiudad(), guia.getCredencial().getIdCredencial());
